...
<body>
    ...
    margin: 0px -732px 0px;
">
                <ion-icon name="bonfire-sharp" role="img" class="md hydrated" aria-label="bonfire sharp"></ion-icon>
            </span> -->

            <div class="col-lg-6" style="margin-top: 14px;width: 50%;">
                <span class="logo">
                    <ion-icon name="bonfire-sharp" role="img" class="md hydrated" aria-label="bonfire sharp"></ion-icon>
                </span>
            </div>
...
{ echo'<p style="color:red;font-size:15px;">'.@$_GET['q7'];}?>
    ...
    <div class="row footer">
        ...
        <div class="col-md-3 box">
            <a href="https://github.com/JahirMullick" data-toggle="modal" target="_blank">Developer</a>
        </div>
        <div class="col-md-3 box">
